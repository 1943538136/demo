...
public class IdWorker {
    ...
    // private static IdWorker idWorker = new IdWorker((int) (Math.random() * 32),
    // (int) (Math.random() * 32));
    private static SimpleDateFormat timeFormat = new SimpleDateFormat("yyyy-MM-dd HH:mm:dd");
    ...
    public static long getId() {
        long workerId = (int) (Math.random() * 32);
        long datacenterId = (int) (Math.random() * 32);
